...
--composition
./Problem1_a_composition 255 255 220 ./result/problem1/mirrored_dog.raw ./images/problem1/beach.raw ./result/problem1/dog_beach_compositi^C_R255B255G220.raw 300 808 1914
...
--please do some adjustment in the cpp file to try:
--median only
--gaussian only
--gaussian first + median
